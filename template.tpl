...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Bloomreach Pageview Tag",
  "brand": {
    "id": "brand_dummy",
    "displayName": "",
    ...
    "subParams": [
      {
        "type": "CHECKBOX",
        "name": "debug",
        "checkboxText": "Log debug messages to console \u0026 Event Diagnostics report",
        "simpleValueType": true
      }
    ]
  }
...
if(containerVersion.debugMode == true & debug_mode == true){
